        ...
        for (;;) {
            ...
            if (message instanceof HttpRequest) {
                ...
                if (!msg.getRequestURI().endsWith("/sse")) {
                    String blockingCallsOuput
                            = //                            BlockingCallsExample.executeSomeSql(ds) +
...
//                        listeners.add(wrapAsSSE(sseActor));
    ...
    private static String buildHtml(String blockingCallsOutput, HttpRequest msg, int i) {
        return "<h1>ParllelUniverse Webactor example</h1>\n"
                ...
                + " </form>\n"
                + "<h3>SSE push</h3>\n"
                + " <script type=\"text/javascript\" src=\"static/mySSE.js\" ></script>\n"
                + " <form>\n"
    ...
    public static void main(String[] args) throws IOException, InterruptedException, Exception {
        ...
        rh.setResourceBase("build/resources/main");
        final ContextHandler staticCtx = new ContextHandler();
        ...
        handlers.setHandlers(new Handler[]{staticCtx, webActorsContext});
